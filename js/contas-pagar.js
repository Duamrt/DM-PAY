...
(function() {
  ...
  async function init() {
    ...
    if (cpSfTrigger) {
      ...
      cpSfDrop.style.cssText = 'display:none;position:fixed;background:var(--bg-surface);border:1px solid var(--border);border-radius:8px;box-shadow:var(--shadow-lg);z-index:9999;min-width:148px;padding:4px';
      cpSfDrop.innerHTML = `
