...
(async function() {
  ...
  let _va = null;
  try { _va = _isPa && _vaRaw ? JSON.parse(_vaRaw) : null; } catch(_) { sessionStorage.removeItem('dmpay-view-as'); }
